    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='students/default.png', upload_to='students', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 2, 21, 14, 23, 40, 752632, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('students', models.ManyToManyField(null=True, to='app.student', verbose_name='Студенты')),
            ],
            options={
                'verbose_name': 'Приказ',
